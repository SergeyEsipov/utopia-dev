...
export const MEDIA_VERSION = "20260622-2300";
...
export function resolveVideoUrl(url, { format } = {}) {
  ...
  const useWebM =
    !directSource &&
    !MP4_ONLY_VIDEOS.has(name) &&
    (format === "webm" || (format !== "mp4" && prefersWebMVideo()));
